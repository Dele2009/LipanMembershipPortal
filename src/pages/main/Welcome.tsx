...
function WelcomePage() {
  ...
  return (
    <>
      <PageMeta>
        <title>Welcome | LIPAN</title>
        <meta
          name="description"
          content="Welcome to LIPAN, empowering Nigerians through literacy and development."
        />
      </PageMeta>
      <div className="flex min-h-screen flex-col bg-gradient-to-b from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="flex flex-col items-center bg-gradient-to-r from-blue-300 via-white to-gray-100 dark:from-blue-900 dark:via-gray-800 dark:to-gray-900 px-4 py-16 text-center">
          ...
          <p className="mt-6 max-w-3xl text-lg text-gray-600 dark:text-gray-300">
            ...
            Established in 1984, we are dedicated to empowering Nigerians with
            the knowledge and skills for sustainable development.
          </p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <Card className="dark:bg-gray-900 dark:border-gray-700">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  ...
                  literacy and sustainable development across Nigeria and
                  beyond.
                </p>
              </Card>
              <Card className="dark:bg-gray-900 dark:border-gray-700">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  ...
                  Nigerians with literacy skills to achieve personal and
                  national growth.
                </p>
              </Card>
            </div>
        ...
        <div className="bg-blue-700 py-16 text-center text-white dark:bg-blue-800">
          ...
          <p className="mt-4 text-lg">
            Explore exclusive member resources, collaborate with peers, and make
            a difference in literacy development.
          </p>
